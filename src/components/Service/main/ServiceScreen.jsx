        ...
        <>
            <div className="text-white flex justify-center text-center flex-col">
                <div>
                    ...
                    <h3 className="text-xs text-gray-400 tracking-widest p-2">Modern, responsive websites built with React, Tailwind CSS, and Bootstrap for a seamless experience across all devices.</h3>
                </div>
